...
public class Utilities {
 ...
 @Parameters({"browser","Wbsite"})
  ...
  public void Browsers(String browsers, String Wbsite) {
	  if(browsers.equalsIgnoreCase("Chrome")) {
		...
		driver.manage().window().maximize();
		  ...
		  System.setProperty("webdriver.edge.driver", "C:\\Users\\riaz_\\git\\repository16\\AutomationPractice7\\src\\Drivers\\msedgedriver.exe");
  ...
  public void shots() throws IOException {
	  ...
	  FileHandler.copy(ks, new File("C:\\Users\\riaz_\\git\\repository16\\AutomationPractice7\\Pictures\\"+sd+"pictureOfWebsite.jpg"));
